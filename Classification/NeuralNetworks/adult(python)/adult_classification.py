...
def train_net(training_data, testing_data, epochs):
    ...
    #gets only last column (classifier) and store as numpy array
...
#bar graph of maximum values for each dataset
